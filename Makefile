...
live_translator:
	hurl --very-verbose --continue-on-error --test --report-html live_translator/report/ --variables-file live_translator/env/uat.env --max-time 60 live_translator/translate/text_translate/*.hurl
